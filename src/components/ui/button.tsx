...
const buttonVariants = cva(
  // rounded-full: pill buttons are Direction B's shape signature (locked
  // 2026-07-26). Buttons inside a button-group keep rounded-lg via the
  // in-data-[slot=button-group] overrides below — pills don't segment.
