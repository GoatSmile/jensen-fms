...
export default function Loading() {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-4 p-4 pb-24 sm:p-6 sm:pb-28">
      ...
      <div className="bg-muted/60 h-36 animate-pulse rounded-lg border" />
      <div className="bg-muted/50 h-32 animate-pulse rounded-lg border" />
      <div className="bg-muted/50 h-28 animate-pulse rounded-lg border" />
      <div className="bg-muted/50 h-24 animate-pulse rounded-lg border" />
    </div>
  );
}
