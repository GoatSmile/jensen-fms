...
/**
 * Retired /admin/colors/[id] — the seven controlled vocabularies now live on one page,
 ...
 */
export default function RetiredColorsDetailPage() {
  redirect("/admin/lists?vocab=colors");
}
