...
/**
 * Retired /admin/families/[id] — the seven controlled vocabularies now live on one page,
 ...
 */
export default function RetiredFamiliesDetailPage() {
  redirect("/admin/lists?vocab=families");
}
