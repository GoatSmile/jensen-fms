...
/**
 * Retired /admin/categories/[id] — the seven controlled vocabularies now live on one page,
 ...
 */
export default function RetiredCategoriesDetailPage() {
  redirect("/admin/lists?vocab=categories");
}
