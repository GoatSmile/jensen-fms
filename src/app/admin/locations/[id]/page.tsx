...
/**
 * Retired /admin/locations/[id] — the seven controlled vocabularies now live on one page,
 ...
 */
export default function RetiredLocationsDetailPage() {
  redirect("/admin/lists?vocab=locations");
}
