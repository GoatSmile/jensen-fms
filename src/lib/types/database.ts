  ...
  public: {
    Tables: {
      app_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "app_settings_last_actor_id_fkey"
      ...
      bike_state_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "bike_state_log_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "people"
            referencedColumns: ["id"]
      ...
      bikes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bikes_last_actor_id_fkey"
            columns: ["last_actor_id"]
            isOneToOne: false
            referencedRelation: "people"
            referencedColumns: ["id"]
      ...
      invoices: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoices_payment_recorded_by_fkey"
      ...
      people: {
        ...
        Relationships: [
          {
            foreignKeyName: "people_last_actor_id_fkey"
            columns: ["last_actor_id"]
            isOneToOne: false
            referencedRelation: "people"
            referencedColumns: ["id"]
      ...
      service_price_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_price_items_last_actor_id_fkey"
            columns: ["last_actor_id"]
            isOneToOne: false
            referencedRelation: "people"
            referencedColumns: ["id"]
