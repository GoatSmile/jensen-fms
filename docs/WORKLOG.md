...
| Date | Hours | Work |
|---|---|---|
| Wed 2026-09-02 | ~15 | **SO → paint order walkable, painted parts become stock** (migrations 89–92): painter + PO documents in the supplier's language, a picker by customer order, painted variants per colour with shelf view, promised/at-painter counts and colour-aware builds, the TEST rule, a docs sweep. |

**September so far: ~15 h** (1 working day)

---

**Project total: ~269 h across 42 working days (2026-05-07 → 2026-09-02)**
