...
| Fri 2026-09-04 | ~4 | **The offer decided, *tilbud* reserved, lines made shared.** Owner picked offers-as-entity on a shared commercial-lines layer. Danish *tilbud* swept back to the customer document; the SO's 1,300-line lines UI became one machine both documents use. |

**September so far: ~28 h** (3 working days)

---

**Project total: ~282 h across 44 working days (2026-05-07 → 2026-09-04)**
