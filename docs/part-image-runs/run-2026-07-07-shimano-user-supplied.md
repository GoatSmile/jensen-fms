...
## Totals
- Attempted: 3 parts · Imaged: 2 parts (3 attachments) · Held: 1 part
- Coverage: **71 → 73 / 176 parts** (74 attachments incl. 1 gallery)

## Attached
| SKU | Name | Model | Attachment(s) | Confidence | Basis |
|---|---|---|---|---|---|
| JP-7gDAAS | 7g Bagnav shimano friløb til SKIVEBREMS | Shimano Nexus **SG-C3001-7D** | hero (silver) + gallery (black) | ~95 | Official Shimano product shots, white bg, "SHIMANO Nexus" branding, filename = `P-SG-C3001-7D` (identity-anchored). Vision-verified. |
...
## Held (still no image)
| SKU | Name | Model | Reason |
|---|---|---|---|
| JP-7gCADXR | 7g Bagnav shimano med fodbremse | Shimano Nexus **SG-C3001-7C** (coaster) | Owner's two saved hub files were both the **7D disc** hub, not the **7C coaster** hub. Grab the SG-C3001-7C shot next: `bike.shimano.com/en-EU/product/component/nexus-c3000-int7/SG-C3001-7C.html`. |
